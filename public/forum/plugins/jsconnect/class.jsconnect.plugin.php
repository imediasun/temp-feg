...
//   }
   ...
   public function Base_ConnectData_Handler($Sender, $Args) {
      ...
      $timestamp = GetValue('timestamp', $JsData, FALSE, TRUE);
      ...
      if (!GetValue('TestMode', $Provider)) {
         ...
         $CalculatedSignature = md5($timestamp.GetValue('AssociationSecret', $Provider));
         // TODO Enable this signature auth code below in production [commented as of 15 May 2017 Element5 ]

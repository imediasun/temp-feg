    ...
    */
    public function ProfileController_AddProfileTabs_Handler($Sender){
        ...
        $Sender->AddProfileTab('KarmaBank','profile/karmabank/'.$Sender->User->UserID.'/'.rawurlencode($Sender->User->Name),
                        'KarmaBank',T('KarmaBank.KarmaBank','Karma Bank').(is_numeric($Balance->Balance) ? '<span class="Count">'.sprintf(T('KarmaBank.NumberFormat',"%01.2f"),$Balance->Balance).'</span>':''));
    }

    ...
    var c = {
        ...
        f = function() {
            var b = function(a) {
                ...
                x = function(a, b) {
                    if (0 === b) return a;
                    if (b >= t(a)) return a.nextSibling;
                    if (s(a)) return a.splitText(b);
        ...
        k = function() {
            ...
            this.insertImage = function(b, c) {
                ...
                e({
                    ...
                    } else document.execCommand("createlink", !1, f)
                })
                ...
                d(b);
                for (var f, h = e.split("x"), i = h[0], j = h[1], k = [], l = c.bMSIE ? "&nbsp;" : "<br/>", m = 0; i > m; m++) k.push("<td>" + l + "</td>");
                f = k.join("");
        ...
        m = function() {
            var b = function(b, c) {
                var d = a(c),
                    e = d.position(),
                    f = d.height();
                dd = d.closest('.sbox.containerBox').offset();
                if (!dd) {
                    ee = d.position();
                    dd = {};
                } else {
                ...
                $(".note-link-popover").css({
                    top:(Number($(d).position().top)+20)+"px",
                    display: "block",
                    left: 3 + ee.left - (dd.left || 0)
                });
               /* b.css({
                    display: "block",
                    left: 3 + ee.left - (dd.left || 0),
                    top: ee.top + f - (dd.top || 0)
                });*/
            };
        ...
        o = function() {
            this.showImageDialog = function(b, c, d, e) {
                var f = b.find(".note-image-dialog"),
                    ...
                    h = b.find(".note-image-url"),
                    i = b.find(".note-image-btn");
                f.on("shown.bs.modal", function() {
                    g.on("change", function() {
                        d(this.files), a(this).val(""), f.modal("hide")
                    }), h.val("").keyup(function() {
                        h.val() ? i.removeClass("disabled").attr("disabled", !1) : i.addClass("disabled").attr("disabled", !0)
            ...
            }, this.showVideoDialog = function(a, b, c) {
                var d = a.find(".note-video-dialog"),
                    e = d.find(".note-video-url"),
                    f = d.find(".note-video-btn");
                d.on("show.bs.modal", function() {
                    e.val(b.text).keyup(function() {
                        e.val() ? f.removeClass("disabled").attr("disabled", !1) : f.addClass("disabled").attr("disabled", !0)
                    }).trigger("keyup").trigger("focus"), f.click(function(a) {
                        d.modal("hide"), c(e.val()), a.preventDefault()
                    })
                }).on("hidden.bs.modal", function() {
                    e.off("keyup"), f.off("click"), d.off("show.bs.modal hidden.bs.modal")
                }).modal("show")
        ...
        p = function() {
            var d = new k,
                ...
                v = function(a) {
                    ...
                    c && (e.update(b.toolbar(), c), g.update(b.popover({
                        container: 'body'
                    }), c), i.update(b.handle(), c))
                },
                w = function(a) {
                    var b = q(a.currentTarget || a.target);
                ...
                x = function(b) {
                    if (f.isControlSizing(b.target)) {
                        var c, e = q(b.target),
                            ...
                            k = e.editable(),
                            l = e.editor(),
                            m = h.find(".note-control-selection").data("target"),
                            n = a(m),
                            o = n.offset(),
                ...
                z = function(g) {
                    ...
                    if (h.length > 0) {
                        ...
                        if (-1 !== a.inArray(k, ["resize", "floatMe"])) {
                            var w = m.handle(),
                                x = w.find(".note-control-selection");
                            i = x.data("target")
                        }
                        if (d[k] && (r.trigger("focus"), d[k](r, l, i)), -1 !== a.inArray(k, ["backColor", "foreColor"])) e.updateRecentColor(h[0], k, l);
                        else if ("showLinkDialog" === k) r.focus(), d.setLinkDialog(r, function(a, b) {
                            j.showLinkDialog(p, a, b)
                        });
                        else if ("showImageDialog" === k) r.focus(), j.showImageDialog(p, t, function(a) {
                            s(r, a)
                        }, function(a) {
                            d.restoreRange(r), d.insertImage(r, a)
                        });
                        else if ("showVideoDialog" === k) r.focus(), d.setVideoDialog(r, function(a, b) {
                            j.showVideoDialog(p, a, b)
                        });
                        else if ("showHelpDialog" === k) j.showHelpDialog(p);
                            ...
                            var y = function() {
                                ...
                                z = n.hasClass("fullscreen");
                            if (z) r.data("orgHeight", r.css("height")), a(window).resize(y).trigger("resize");
                            else {
                                var A = !!r.data("optionHeight");
                                r.css("height", A ? r.data("orgHeight") : "auto"), a(window).off("resize")
                            }
                            e.updateFullscreen(o, z)
                        } else if ("codeview" === k) {
                            n.toggleClass("codeview");
                            var B = n.hasClass("codeview");
                            if (B) {
                                if (u.val(r.html()), u.height(r.height()), e.disable(o), u.focus(), c.bCodeMirror) {
                                    var C = b.fromTextArea(u[0], a.extend({
                                        mode: "text/html",
                                        lineNumbers: !0
                                    }, n.data("options").codemirror));
                                    C.setSize(null, r.outerHeight()), C.autoFormatRange && C.autoFormatRange({
                                        line: 0,
                                        ch: 0
                                    }, {
                                        line: C.lineCount(),
                            ...
                            } else c.bCodeMirror && u.data("cmEditor").toTextArea(), r.html(u.val() || f.emptyPara), r.height(r.data("optionHeight") ? u.height() : "auto"), e.enable(o), r.focus();
                            e.updateCodeview(m.toolbar(), B)
                        }
                        v(g)
                    }
                },
                ...
                E = function(b) {
                    ...
                    a(document).on("dragenter", function(a) {
                        ...
                        t(d), c = a(), b.editor.removeClass("dragover")
                    }).on("dragover", !1)
                };
        ...
        r = function() {
            ...
            var p = function(b, d) {
                ...
                s = function(b) {
                    b.find(".note-color-palette").each(function() {
                        for (var b = a(this), c = b.attr("data-target-event"), d = "", e = 0, f = r.length; f > e; e++) {
                            for (var g = r[e], h = "<div>", i = 0, j = g.length; j > i; i++) {
                                var k = g[i],
            ...
            this.createLayout = function(c, i) {
                ...
                if (!c.next().hasClass("note-editor")) {
                    var n = a('<div class="note-editor"></div>');
                    n.data("options", i), k > 0 && a('<div class="note-statusbar">' + h + "</div>").prependTo(n);
                    var o = a('<div class="note-editable" contentEditable="true"></div>').prependTo(n);
                    k && (o.height(k), o.data("optionHeight", k)), l && o.data("tabsize", l), o.html(f.html(c) || f.emptyPara), o.data("NoteHistory", new j), a('<textarea class="note-codable"></textarea>').prependTo(n), setTimeout(function() {
                        document.execCommand("styleWithCSS", 0, !0)
                    });
                    for (var r = "", t = 0, u = m.length; u > t; t++) {
                        var v = m[t];
                        r += '<div class="note-' + v[0] + ' btn-group">';
                        for (var w = 0, x = v[1].length; x > w; w++) r += b[v[1][w]](q[i.locale]);
                        r += "</div>"
                    }
                    r = '<div class="note-toolbar btn-toolbar">' + r + "</div>";
                    var y = a(r).prependTo(n);
                    s(y), p(y, "bottom");
                    var z = a(d(q[i.locale])).prependTo(n);
                    p(z), a(e).prependTo(n);
                    var A = a(g(q[i.locale])).prependTo(n);
                    A.find("button.close, a.modal-close").click(function() {
                        a(this).closest(".modal").modal("hide")
                    }), a('<div class="note-dropzone"><div class="note-dropzone-message"></div></div>').prependTo(n), n.insertAfter(c), c.hide()
                }
            };
            var t = this.layoutInfoFromHolder = function(a) {
                var b = a.next();
                if (b.hasClass("note-editor")) return {
                    editor: b,
                    dropzone: b.find(".note-dropzone"),
    ...
    a.fn.extend({
        summernote: function(b) {
            if (b = a.extend({
                    ...
                    var e = a(d);
                    s.createLayout(e, b);
                    var g = s.layoutInfoFromHolder(e);
                    t.attach(g, b), f.isTextarea(e[0]) && e.closest("form").submit(function() {
                        e.html(e.code())
                    })
                }), this.first() && b.focus) {
                var c = s.layoutInfoFromHolder(this.first());
                c.editable.focus()
            }
        ...
        code: function(b) {
            if (void 0 === b) {
                ...
                var e = s.layoutInfoFromHolder(d);
                if (e && e.editable) {

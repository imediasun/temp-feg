...
@if($setting['form-method'] =='native')
	<div class="sbox">
		<div class="sbox-title">  
			<h4> @if($id)
					<i class="fa fa-pencil"></i>&nbsp;&nbsp;Edit Report: Readers with missing asset id
				@else
					<i class="fa fa-plus"></i>&nbsp;&nbsp;Create New Report: Readers with missing asset id
				@endif
...
@endif	
			{!! Form::open(array('url'=>'readersmissingassetidreport/save/'.SiteHelpers::encryptID($row['id']), 'class'=>'form-horizontal','files' => true , 'parsley-validate'=>'','novalidate'=>' ','id'=> 'readersmissingassetidreportFormAjax')) !!}
			<div class="col-md-12">
						<fieldset>
				...
				<div class="input-group m-b" style="width:150px !important;">
					{!! Form::text('date_start', $row['date_start'],array('class'=>'form-control datetime', 'style'=>'width:150px !important;')) !!}
				...
				<div class="input-group m-b" style="width:150px !important;">
					{!! Form::text('date_end', $row['date_end'],array('class'=>'form-control datetime', 'style'=>'width:150px !important;')) !!}
					<span class="input-group-addon"><i class="fa fa-calendar"></i></span>
				</div>
...
$(document).ready(function() { 
	...
	var form = $('#readersmissingassetidreportFormAjax'); 
	form.parsley();

...
@if($setting['form-method'] =='native')
	<div class="sbox">
		<div class="sbox-title">  
			<h4> @if($id)
					<i class="fa fa-pencil"></i>&nbsp;&nbsp;Edit Top Game Report
				@else
					<i class="fa fa-plus"></i>&nbsp;&nbsp;Create New Top Game Report
				@endif
...
@endif	
			{!! Form::open(array('url'=>'topgamesreport/save/'.SiteHelpers::encryptID($row['id']), 'class'=>'form-horizontal','files' => true , 'parsley-validate'=>'','novalidate'=>' ','id'=> 'topgamesreportFormAjax')) !!}
			<div class="col-md-12">
						<fieldset>
...
$(document).ready(function() { 
	...
	var form = $('#topgamesreportFormAjax'); 
	form.parsley();

...
<div class="sbox">
	<div class="sbox-title">
		...
		<div class="sbox-tools" >
			<a href="javascript:void(0)" class="btn btn-xs btn-white tips" title="Clear Search" onclick="reloadData('#{{ $pageModule }}','managefreightquoters/data?search=')"><i class="fa fa-trash-o"></i> Clear Search </a>
			<a href="javascript:void(0)" class="btn btn-xs btn-white tips" title="Reload Data" onclick="reloadData('#{{ $pageModule }}','managefreightquoters/data?return={{ $return }}')"><i class="fa fa-refresh"></i></a>
    ...
    <table class="table table-striped  datagrid" id="{{ $pageModule }}Table">
        ...
        <tr>
            ...
            @endif
				...
				@if($setting['disableactioncheckbox']=='false' && ($access['is_remove'] == 1 || $access['is_add'] =='1') && \Session::get('freight_status') != 'archive')

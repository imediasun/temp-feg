@if($setting['form-method'] =='native')
    <div class="sbox">
        ...
        <div class="sbox-content">
            @endif
            {!! Form::open(array('url'=>'managefreightquoters/save/'.SiteHelpers::encryptID($row['id']),
            ...
            <div class="col-md-8 col-md-offset-2" style="background: #FFF;box-shadow:1px 1px 5px lightgray">
                <fieldset>
                        ...
                        <div id="from_div">
                            ...
                            <div class="col-md-12" id="std_from_div">
                                <div class="form-group">
                                    ...
                                    <div class="col-md-6">
                                        <input type="text" name="from_add_name" id="from_add_name"
                                               ...
                                               placeholder="Vendor/Customer Name" class="form-control" required/>
                                    </div>
                                ...
                                <div class="form-group">
                                    ...
                                    <div class="col-md-6">
                                        <input type="text" name="from_add_street" id="from_add_street"
                                               ...
                                               placeholder="Street Address" class="form-control" required/>
                                    </div>
                                    <div class="col-md-2"></div>
                                </div>
                                <div class="form-group">
                                ...
                                <div class="form-group">
                                    ...
                                    <div class="col-md-6">
                                        <input type="text" name="from_contact_phone" id="from_contact_phone"
                                               value="<?php //echo set_value('from_contact_phone'); ?>"
                                               placeholder="Phone #" class="form-control" style="width:33%;float:left"/>
                                        <input type="text" name="from_contact_email" id="from_contact_email"
                                ...
                                <div class="form-group">
                                    ...
                                    <div class="col-md-6">
                                        <input type="checkbox" name="add_from_vendor_to_list"
                                               value="<?php// echo set_value('add_from_vendor_to_list') ? 'checked': ''; ?>"
                                               id="add_from_vendor_to_list">

                                        <div id="from_vendor_type_div" class="pull-right"
                                             style="margin-right:40px <?php// echo set_value('add_from_vendor_to_list') ? ' display: block;': ''; ?>">
                                            <?php
                                            ...
                                            <div>
                                                <label>
                                                    <input type="radio" name="from_vendor_type"
                                                           value="games" <?php //echo $is_game_checked ? 'checked' : ''; ?>>&nbsp&nbsp
                                                    GAMES Vendor<br/>
                                                </label>
                                            </div>
                                            <div>
                    ...
                    <div class="form-group  ">
                        <div class="col-md-8 col-md-offset-2">
                            <label class="radio-inline">
                                <input type="radio" name="from_type_to" value="location" id="radio_to_loc">&nbsp&nbsp
                                Our Location </label>
                            <label class="radio-inline">
                                <input type="radio" name="from_type_to" value="vendor" id="radio_to_vend">&nbsp&nbsp
                                Vendor on File
                            </label>
                            <label class="radio-inline">
                                <input type="radio" name="from_type_to" value="blank" id="radio_to_blank"> &nbsp&nbsp
                                Blank Form
                            </label>
                        </div>
                    </div>
                        ...
                        <div id="from_div">
                            <div class="col-md-6 col-md-offset-4" id="location_to_div">
                                <div class="clone clonedInput">
                                    ...
                                    <div class="col-md-1">
                                        <a onclick=" $(this).parents('.clonedInput').remove(); calculateSum(); return false"
                            ...
                            <div class="col-md-12" id="std_to_div">
                                ...
                                <div class="form-group">
                                    ...
                                    <div class="col-md-6">
                                        <input type="text" name="to_contact_phone" id="to_contact_phone"
                                               value="<?php //echo set_value('from_contact_phone'); ?>"
                                               placeholder="Phone #" class="form-control" style="width:33%;float:left"/>
                                        <input type="text" name="to_contact_email" id="to_contact_email"
                                               value="<?php //echo set_value('from_contact_email'); ?>"
                                               placeholder="Email Address" class="form-control"
                                               style="width:66%;float:right"/>
                    ...
                    <div class="text-center col-md-3 col-md-offset-5" style="padding-left:60px">

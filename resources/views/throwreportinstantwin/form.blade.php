...
@if($setting['form-method'] =='native')
	<div class="sbox">
		<div class="sbox-title">  
			<h4> @if($id)
					<i class="fa fa-pencil"></i>&nbsp;&nbsp;Edit Throw Report Instant Win
				@else
					<i class="fa fa-plus"></i>&nbsp;&nbsp;Create New Throw Report Instant Win
				@endif
...
@endif	
			{!! Form::open(array('url'=>'throwreportinstantwin/save/'.SiteHelpers::encryptID($row['id']), 'class'=>'form-horizontal','files' => true , 'parsley-validate'=>'','novalidate'=>' ','id'=> 'throwreportinstantwinFormAjax')) !!}
			<div class="col-md-12">
						<fieldset>
...
$(document).ready(function() { 
	...
	var form = $('#throwreportinstantwinFormAjax'); 
	form.parsley();

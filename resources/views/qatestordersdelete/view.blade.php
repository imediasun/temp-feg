		...
		<table class="table table-striped table-bordered" >
			<tbody>	
					...
					<tr>
						...
						<td>{{ $row->invoice_verified_date }} </td>
					...
					<tr>
						...
						<td>{{ $row->po_notes_additionaltext }} </td>

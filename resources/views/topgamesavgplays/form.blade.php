...
@endif	
			{!! Form::open(array('url'=>'topgamesavgplays/save/'.SiteHelpers::encryptID($row['id']), 'class'=>'form-horizontal','files' => true , 'parsley-validate'=>'','novalidate'=>' ','id'=> 'topgamesavgplaysFormAjax')) !!}
			<div class="col-md-12">
						<fieldset><legend> Top Games by Average Plays</legend>
...
$(document).ready(function() { 
	...
	var form = $('#topgamesavgplaysFormAjax'); 
	form.parsley();

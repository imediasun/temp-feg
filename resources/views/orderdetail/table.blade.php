...
<div class="sbox">
	...
	@include( $pageModule.'/toolbar')
	 ...
	 <?php echo Form::open(array('url'=>'orderdetail/delete/', 'class'=>'form-horizontal' ,'id' =>'SximoTable'  ,'data-parsley-validate'=>'' )) ;?>
                ...
                <tr class="editable" id="form-{{ $row->productCode }}">
					...
					@endif			
					 <?php foreach ($tableGrid as $field) :
						...
						endforeach; 
					  ?>
				 <td data-values="action" data-key="<?php echo $row->productCode ;?>">
					{!! AjaxHelpers::buttonAction('orderdetail',$access,$id ,$setting) !!}
					{!! AjaxHelpers::buttonActionInline($row->productCode,'productCode') !!}		
				</td>			 
                </tr>
                @if($setting['view-method']=='expand')
                <tr style="display:none" class="expanded" id="row-{{ $row->productCode }}">
                	<td class="number"></td>
                	<td></td>
                	<td></td>

                    ...
                    <tr class="editable" id="form-{{ $row->id }}">
                        ...
                        <td><a href="{{ $pageModule }}/show/{{$row->id}}" target="_blank"
                            ...
                            @if($row->inactive == 0)
                                ...
                                <a href="javascript:void(0)" class="addToCart" value="{{$row->id}}" class="tips btn btn-xs btn-white"  title="Add to Cart"><i class="fa fa-shopping-cart" aria-hidden="true"></i></a>
                            @else
                                Not Avail.
                            @endif
                        </td>

                ...
                <table class="table table-striped  datagrid" id="{{ $pageModule }}Table">
                    ...
                    <tr class="editable" id="form-{{ $row->id }}">
                        ...
                        <td>@if($row->inactive == 0)
                                <input type="number" title="Quantity" onkeyup="if(!this.checkValidity()){this.value='';alert('Please enter a number')};" name="item_quantity" class="form-control" style="width:70px;display:inline" id="item_quantity_{{$row->id}}" min="0"  />

...
@endif	
			{!! Form::open(array('url'=>'merchthrowssimple/save/'.SiteHelpers::encryptID($row['id']), 'class'=>'form-horizontal','files' => true , 'parsley-validate'=>'','novalidate'=>' ','id'=> 'merchthrowssimpleFormAjax')) !!}
			<div class="col-md-12">
						<fieldset><legend> MerchThrowsSimple</legend>
...
$(document).ready(function() { 
	...
	var form = $('#merchthrowssimpleFormAjax'); 
	form.parsley();

...
@endif	
			{!! Form::open(array('url'=>'merchthrowsdetailed/save/'.SiteHelpers::encryptID($row['id']), 'class'=>'form-horizontal','files' => true , 'parsley-validate'=>'','novalidate'=>' ','id'=> 'merchthrowsdetailedFormAjax')) !!}
			<div class="col-md-12">
						<fieldset><legend> merchthrowsdetailed</legend>
...
$(document).ready(function() { 
	...
	var form = $('#merchthrowsdetailedFormAjax'); 
	form.parsley();

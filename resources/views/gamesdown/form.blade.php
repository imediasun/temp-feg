...
@endif	
			{!! Form::open(array('url'=>'gamesdown/save/'.SiteHelpers::encryptID($row['id']), 'class'=>'form-horizontal','files' => true , 'parsley-validate'=>'','novalidate'=>' ','id'=> 'gamesdownFormAjax')) !!}
			<div class="col-md-12">
						<fieldset><legend> Games Down</legend>

		...
		<table class="table table-striped table-bordered" id="table">
          ...
          <tr>
            ...
            <td class="formSimpleSearchFieldWidth">
                ...
                <?php $advancedsearchoperator = (isset($rows['advancedsearchoperator']) ? $rows['advancedsearchoperator'] : 'equal'); ?>
                <input type="hidden" name="advancedsearchoperator[<?php echo $id;?>]" value="<?php echo $advancedsearchoperator;?>" />
            ...
            <td class="formFieldConfig">
                ...
                <input type="hidden" name="lookup_search[<?php echo $id;?>]" value="{!! isset($rows['option']['lookup_search']) ? $rows['option']['lookup_search'] : '' !!}" />

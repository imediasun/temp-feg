...
@endif	
			{!! Form::open(array('url'=>'tablecoll/save/'.SiteHelpers::encryptID($row['id']), 'class'=>'form-horizontal','files' => true , 'parsley-validate'=>'','novalidate'=>' ','id'=> 'tablecollFormAjax')) !!}
			<div class="col-md-12">
						<fieldset><legend> tablecoll</legend>
				  ...
				  <div class="form-group  " > 
					...
					<div class="col-md-6">
					  {!! Form::text('config_name', $row['config_name'],array('class'=>'form-control', 'placeholder'=>'',   )) !!} 
					 </div> 
					 <div class="col-md-2">
				  ...
				  <div class="form-group  " > 
					<label for="Is Private" class=" control-label col-md-4 text-left"> 
					{!! SiteHelpers::activeLang('Is Private', (isset($fields['is_private']['language'])? $fields['is_private']['language'] : array())) !!}	
					</label>
					<div class="col-md-6">
					  {!! Form::text('is_private', $row['is_private'],array('class'=>'form-control', 'placeholder'=>'',   )) !!} 
					 </div> 
					 <div class="col-md-2">

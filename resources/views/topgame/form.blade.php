...
@endif	
			{!! Form::open(array('url'=>'topgame/save/'.SiteHelpers::encryptID($row['id']), 'class'=>'form-horizontal','files' => true , 'parsley-validate'=>'','novalidate'=>' ','id'=> 'topgameFormAjax')) !!}
			<div class="col-md-12">
						<fieldset><legend> Top Game Report</legend>

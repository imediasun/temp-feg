...
<div class="sbox">
	...
	<div class="sbox-content">
	 <?php echo Form::open(array('url'=>'tasks/delete/', 'class'=>'form-horizontal' ,'id' =>'SximoTable'  ,'data-parsley-validate'=>'' )) ;?>
			...
			<tr id="form-0" >
			  ...
			  @endif
                ...
                <tr class="editable" id="form-{{ $row->id }}">
					...
					<td><a href="javascript:void(0)" class="expandable" rel="#row-{{ $row->id }}" data-url="{{ url('tasks/show/'.$id) }}"><i class="fa fa-plus " ></i></a></td>
					@endif

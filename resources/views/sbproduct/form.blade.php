...
@endif	
			{!! Form::open(array('url'=>'sbproduct/save/'.SiteHelpers::encryptID($row['ProductID']), 'class'=>'form-horizontal','files' => true , 'parsley-validate'=>'','novalidate'=>' ','id'=> 'sbproductFormAjax')) !!}
			<div class="col-md-12">
						<fieldset><legend> Invoice Products</legend>
								  ...
								  <div class="form-group  " > 
									<label for="Note" class=" control-label col-md-4 text-left"> 

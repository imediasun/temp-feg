...
<div class="sbox">
	<div class="sbox-title"> 
		...
		<div class="sbox-tools" >
			<a href="javascript:void(0)" class="btn btn-xs btn-white tips" title="Clear Search" onclick="reloadData('#{{ $pageModule }}','sbproduct/data?search=')"><i class="fa fa-trash-o"></i></a>
			<a href="javascript:void(0)" class="btn btn-xs btn-white tips" title="Reload Data" onclick="reloadData('#{{ $pageModule }}','sbproduct/data?return={{ $return }}')"><i class="fa fa-refresh"></i></a>
	...
	<div class="sbox-content">
	 ...
	 <?php echo Form::open(array('url'=>'sbproduct/delete/', 'class'=>'form-horizontal' ,'id' =>'SximoTable'  ,'data-parsley-validate'=>'' )) ;?>
			...
			<tr id="form-0" >
			  ...
			  @endif        
           		...
           		<?php foreach ($rowData as $row) : 
           			  $id = $row->ProductID;
           		?>
			<tr @if($access['is_edit']=='1') class="editable" @endif id="form-{{ $row->ProductID }}"
				...
				@if($access['is_edit']=='1') ondblclick="showFloatingCancelSave(this)" @endif @endif>
					...
					<td><a href="javascript:void(0)" class="expandable" rel="#row-{{ $row->ProductID }}" data-url="{{ url('sbproduct/show/'.$id) }}"><i class="fa fa-plus " ></i></a></td>								
					@endif			

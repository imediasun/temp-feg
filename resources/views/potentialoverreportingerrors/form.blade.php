...
@if($setting['form-method'] =='native')
	<div class="sbox">
		<div class="sbox-title">  
			<h4>@if($id)
					<i class="fa fa-pencil"></i>&nbsp;&nbsp;Edit Potential Over-Reporting Errors
				@else
					<i class="fa fa-plus"></i>&nbsp;&nbsp;Create New Potential Over-Reporting Errors
				@endif
...
@endif	
			{!! Form::open(array('url'=>'potentialoverreportingerrors/save/'.SiteHelpers::encryptID($row['id']), 'class'=>'form-horizontal','files' => true , 'parsley-validate'=>'','novalidate'=>' ','id'=> 'potentialoverreportingerrorsFormAjax')) !!}
			<div class="col-md-12">
						<fieldset>
...
$(document).ready(function() { 
	...
	var form = $('#potentialoverreportingerrorsFormAjax'); 
	form.parsley();

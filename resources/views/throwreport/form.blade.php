...
@if($setting['form-method'] =='native')
	<div class="sbox">
		<div class="sbox-title">  
			<h4> @if($id)
					<i class="fa fa-pencil"></i>&nbsp;&nbsp;Edit Throw Report
				@else
					<i class="fa fa-plus"></i>&nbsp;&nbsp;Create New Throw Report
				@endif
...
@endif	
			{!! Form::open(array('url'=>'throwreport/save/'.SiteHelpers::encryptID($row['id']), 'class'=>'form-horizontal','files' => true , 'parsley-validate'=>'','novalidate'=>' ','id'=> 'throwreportFormAjax')) !!}
			<div class="col-md-12">
						<fieldset>

...
<div class="sbox">
    <div class="sbox-title">
        ...
        <div class="sbox-tools" >
            ...
            <a href="javascript:void(0)" class="btn btn-xs btn-white tips" title="Reload Data" onclick="var searchParamsString = 'managefegrequeststore/data'+document.getElementById('searchParamsString').value; reloadData('#{{ $pageModule }}',searchParamsString)"><i class="fa fa-refresh"></i></a>

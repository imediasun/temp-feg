            ...
            <table width="100%"  style="border-collapse: collapse;overflow:hidden;">
                ...
                @for($i=0;$i < count($data[0]['orderDescriptionArray']);$i++)
                    <tr>
                        ...
                        <td style="padding:8px;border:1px dotted #000;border-top:none">  {{CurrencyHelpers::formatCurrency(number_format($data[0]['orderPriceArray'][$i], \App\Models\Order::ORDER_PERCISION)) }} <br/></td>
                        <td style="padding:8px;border:1px dotted  #000;border-top:none">  {{ $data[0]['orderQtyArray'][$i] }} <br/></td>
                        <td style="padding:8px;border:1px dotted  #000;border-top:none ">  $ {{number_format($data[0]['orderPriceArray'][$i]* $data[0]['orderQtyArray'][$i], \App\Models\Order::ORDER_PERCISION) }} <br/></td>

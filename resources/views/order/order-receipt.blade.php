                            ...
                            @foreach($data['order_items'] as $order_item)
                                @if($order_item->qty != $order_item->item_received)
                                    <tr>
                                        ...
                                        <td>
                                            <input type="number"  id="receivedItemText{{ $order_item->id }}" name="receivedQty[]" value="{{ $order_item->qty - $order_item->item_received}}" max="{!! $order_item->qty - $order_item->item_received !!}"  readonly="readonly" />
                                        </td>

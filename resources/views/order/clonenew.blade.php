...
">
                ...
                <td> <input type="text" name="Subtotal" value="{{ CurrencyHelpers::formatPrice($data['order_total'],  \App\Models\Order::ORDER_PERCISION) }}" readonly
        ...
        $(document).ready(function () {
            ...
            $("#location_id").jCombo("{{ URL::to('order/comboselect?filter=location:id:location_name') }}",
                    {selected_value: '{{ $data["order_loc_id"] }}',
                        <?php $data["order_loc_id"] == '' ? '': print_r("onLoad:addInactiveItem('#location_id', ".$data['order_loc_id']." , 'Location', 'active' , 'location_name')") ?>
                    });

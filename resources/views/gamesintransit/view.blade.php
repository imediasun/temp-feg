        ...
        <div class="sbox-content">
            ...
            <table class="table table-striped table-bordered">
                ...
                <tr>
                    ...
                    <td>{!! SiteHelpers::gridDisplayView($row->game_type_id,'game_type_id','1:game_type:id:game_type')
                        !!}
                    </td>
                </tr>
                <tr>
                ...
                <tr>
                    ...
                    <td>{!! SiteHelpers::gridDisplayView($row->status_id,'status_id','1:game_status:id:game_status')
                        !!}
                    </td>
                </tr>
                <tr>
                ...
                <tr>
                    ...
                    <td>{!! SiteHelpers::gridDisplayView($row->for_sale,'for_sale','1:yes_no:id:yesno') !!}</td>
                </tr>
                <tr>
                    <td width='30%' class='label-view text-right'>

...
@endif	
			{!! Form::open(array('url'=>'bottomgame/save/'.SiteHelpers::encryptID($row['id']), 'class'=>'form-horizontal','files' => true , 'parsley-validate'=>'','novalidate'=>' ','id'=> 'bottomgameFormAjax')) !!}
			<div class="col-md-12">
						<fieldset><legend> Bottom Game Report</legend>

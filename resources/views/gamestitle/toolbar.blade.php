<div class="row m-b">
	<div class="col-md-6">
			...
			@if(SiteHelpers::isModuleEnabled('tablecols'))
				<a href="{{ URL::to('tablecols/arrange-cols/'.$pageModule) }}" class="btn btn-sm btn-white" onclick="SximoModal(this.href,'Column Selector'); return false;" ><i class="fa fa-search"></i> Arrange Columns</a>
			@endif

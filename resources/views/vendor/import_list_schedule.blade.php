        ...
        <div class="sbox-content">
            ...
            <div class="col-md-12">
                <fieldset><legend> Schedule Report</legend>
                    ...
                    <div class="form-group  " id="repeatsOn" @if(isset($schedule) && $schedule->reoccur_by == 'monthly') style="display: none" @else style="display: block" @endif>
                    ...
                    <div class="form-group  " id="repeatsOnDate" @if(isset($schedule) && $schedule->reoccur_by == 'monthly') style="display: block" @else style="display: none" @endif>
                        <label for="Repeats On" class=" control-label col-md-4 text-left">
                            Repeats On
                        </label>
                        <div class="col-md-6">
                            {!! Form::selectRange('date', 01, 31, isset($schedule)?$schedule->date:'', array('class'=>'form-control', 'placeholder'=>'',   )) !!}
                        </div>
                        <div class="col-md-2">
                    ...
                    <div class="form-group  " id="repeatsOnDateMonth" @if(isset($schedule) && $schedule->reoccur_by == 'yearly') style="display: block" @else style="display: none" @endif>
                        <label for="Repeats On" class=" control-label col-md-4 text-left">
                            Repeats On
                        </label>
                        <div class="col-md-6">
                            {!! Form::text('date_month',isset($schedule)?$schedule->date.'/'.$schedule->month:'',array('class'=>'form-control date-month', 'placeholder'=>'',   )) !!}
                        </div>
                        <div class="col-md-2">

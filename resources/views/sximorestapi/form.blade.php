...
@endif	
			{!! Form::open(array('url'=>'sximorestapi/save/'.SiteHelpers::encryptID($row['id']), 'class'=>'form-horizontal','files' => true , 'parsley-validate'=>'','novalidate'=>' ','id'=> 'sximorestapiFormAjax')) !!}
			<div class="col-md-12">
						<fieldset><legend> SximoRestAPI</legend>
				  ...
				  <div class="form-group  " >
					...
					<div class="col-md-6">
					  {!! Form::text('apiuser', $row['apiuser'],array('class'=>'form-control', 'placeholder'=>'',   )) !!}
					 </div> 
					 <div class="col-md-2">
				  ...
				  <div class="form-group  " >
					...
					<div class="col-md-6">
					  {!! Form::text('apikey', $row['apikey'],array('class'=>'form-control', 'placeholder'=>'',   )) !!}
					 </div> 
					 <div class="col-md-2">

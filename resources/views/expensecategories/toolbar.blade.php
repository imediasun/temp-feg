<div class="row c-margin">
	<div class="col-md-9">
        ...
        @if(!empty($colconfigs))
        <select class="form-control height-set float-margin" style="width:auto!important;" name="col-config"
                id="col-config">
        ...
        <a id="edit-cols" href="{{ URL::to('tablecols/arrange-cols/'.$pageModule.'/edit') }}" class="btn btn-sm btn-white float-margin"

...
@if($setting['form-method'] =='native')
	<div class="sbox">
		<div class="sbox-title">  
			<h4> @if($id)
					<i class="fa fa-pencil"></i>&nbsp;&nbsp;Edit Report: Game Play
				@else
					<i class="fa fa-plus"></i>&nbsp;&nbsp;Create New Report: Game Play
				@endif
...
@endif	
			{!! Form::open(array('url'=>'gameplayreport/save/'.SiteHelpers::encryptID($row['id']), 'class'=>'form-horizontal','files' => true , 'parsley-validate'=>'','novalidate'=>' ','id'=> 'gameplayreportFormAjax')) !!}
			<div class="col-md-12">
						<fieldset>
...
$(document).ready(function() { 
	...
	var form = $('#gameplayreportFormAjax'); 
	form.parsley();

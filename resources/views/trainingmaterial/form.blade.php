...
@endif	
			{!! Form::open(array('url'=>'trainingmaterial/save/'.$row['id'], 'class'=>'form-horizontal','files' => true , 'parsley-validate'=>'','novalidate'=>' ','id'=> 'trainingmaterialFormAjax')) !!}
			<div class="col-md-12">
...
$(document).ready(function() { 
	...
	var form = $('#trainingmaterialFormAjax'); 
	form.parsley();

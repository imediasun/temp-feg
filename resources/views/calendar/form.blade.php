...
@endif	
			{!! Form::open(array('url'=>'calendar/save/'.SiteHelpers::encryptID($row['id']), 'class'=>'form-horizontal','files' => true , 'parsley-validate'=>'','novalidate'=>' ','id'=> 'calendarFormAjax')) !!}
			<div class="col-md-12">
				  ...
				  <div class="form-group  " > 
					<label for="Start" class=" control-label col-md-4 text-left"> 
				  ...
				  <div class="form-group  " > 
					<label for="End" class=" control-label col-md-4 text-left"> 

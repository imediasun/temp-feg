...
@if($setting['form-method'] =='native')
	<div class="sbox">
		<div class="sbox-title">  
			<h4> @if($id)
					<i class="fa fa-pencil"></i>&nbsp;&nbsp;Edit Games Not Played  Report
				@else
					<i class="fa fa-plus"></i>&nbsp;&nbsp;Create New Games Not Played  Report
				@endif
...
@endif	
			{!! Form::open(array('url'=>'gamesnotplayed/save/'.SiteHelpers::encryptID($row['id']), 'class'=>'form-horizontal','files' => true , 'parsley-validate'=>'','novalidate'=>' ','id'=> 'gamesnotplayedFormAjax')) !!}
			<div class="col-md-12">
						<fieldset>
...
$(document).ready(function() { 
	...
	var form = $('#gamesnotplayedFormAjax'); 
	form.parsley();

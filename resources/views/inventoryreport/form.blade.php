...
@endif	
			{!! Form::open(array('url'=>'inventoryreport/save/'.SiteHelpers::encryptID($row['id']), 'class'=>'form-horizontal','files' => true , 'parsley-validate'=>'','novalidate'=>' ','id'=> 'inventoryreportFormAjax')) !!}
			<div class="col-md-12">
						<fieldset><legend> Inventory Report</legend>
				  ...
				  <div class="form-group  " >
					...
					<div class="col-md-6">
					  <textarea name='alt_address' rows='5' id='alt_address' class='form-control '
				           >{{ $row['alt_address'] }}</textarea>
					 </div> 
					 <div class="col-md-2">
...
$(document).ready(function() { 
	...
	var form = $('#inventoryreportFormAjax'); 
	form.parsley();

...
@if($setting['form-method'] =='native')
	<div class="sbox">
		<div class="sbox-title">  
			<h4> @if($id)
					<i class="fa fa-pencil"></i>&nbsp;&nbsp;Edit Game not on Debit Card
				@else
					<i class="fa fa-plus"></i>&nbsp;&nbsp;Create New Game not on Debit Card
				@endif
...
@endif	
			{!! Form::open(array('url'=>'gamesnotondebitcard/save/'.SiteHelpers::encryptID($row['id']), 'class'=>'form-horizontal','files' => true , 'parsley-validate'=>'','novalidate'=>' ','id'=> 'gamesnotondebitcardFormAjax')) !!}
			<div class="col-md-12">
						<fieldset>
				  ...
				  <div class="form-group  " > 
					...
					<div class="col-md-6">
					  <textarea name='location_id' rows='5' id='location_id' class='form-control '  
				           >{{ $row['location_id'] }}</textarea> 
					 </div> 
					 <div class="col-md-2">
...
$(document).ready(function() { 
	...
	var form = $('#gamesnotondebitcardFormAjax'); 
	form.parsley();

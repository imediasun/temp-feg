...
@foreach ($tableForm as $t)
	...
	@endif
@endforeach
                <tr id="date_start" class="fieldsearch">
			<td>Date Start </td>
			<td id="field_date_start"><input type="text" name="date_start" class="date form-control input-sm" value="" autocomplete="off"> </td>
			<input id="date_start_operate" type="hidden" name="operate" value="equal">
		</tr>
                <tr id="date_end" class="fieldsearch">
			<td>Date End </td>
			<td id="field_date_end"><input type="text" name="date_end" class="date form-control input-sm" value=""> </td>
			<input id="date_end_operate" type="hidden" name="operate" value="equal">
		</tr>                
                <tr>

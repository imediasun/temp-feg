...
@endif	
			{!! Form::open(array('url'=>'bottomgamesavgplays/save/'.SiteHelpers::encryptID($row['id']), 'class'=>'form-horizontal','files' => true , 'parsley-validate'=>'','novalidate'=>' ','id'=> 'bottomgamesavgplaysFormAjax')) !!}
			<div class="col-md-12">
						<fieldset><legend> Bottom Games by Average Plays</legend>
...
$(document).ready(function() { 
	...
	var form = $('#bottomgamesavgplaysFormAjax'); 
	form.parsley();

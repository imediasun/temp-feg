...
@endif	
			{!! Form::open(array('url'=>'productlog/save/'.SiteHelpers::encryptID($row['id']), 'class'=>'form-horizontal','files' => true , 'parsley-validate'=>'','novalidate'=>' ','id'=> 'productlogFormAjax')) !!}
			<div class="col-md-12">
						<fieldset><legend> Reserved Quantity Log</legend>
				  ...
				  <div class="form-group  " >
					<label for="Veriation Id" class=" control-label col-md-4 text-left">
					{!! SiteHelpers::activeLang('Veriation Id', (isset($fields['veriation_id']['language'])? $fields['veriation_id']['language'] : array())) !!}
					</label>
					<div class="col-md-6">
					  {!! Form::text('veriation_id', $row['veriation_id'],array('class'=>'form-control', 'placeholder'=>'',   )) !!}
					 </div> 
					 <div class="col-md-2">

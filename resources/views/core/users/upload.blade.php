        ...
        <div class="page-content-wrapper m-t">
            <div class="sbox animated fadeInRight">
                ...
                <div class="sbox-content">
                    ...
                    <div class="col-md-6 text-center CoreUserImageContainer" >
                            {!! SiteHelpers::showUploadedFile($profile_img,'/uploads/users/',400,false) !!}
                    </div>
                    
                <div class="col-md-6">
                    {!! Form::open(array('url'=>'core/users/upload?return='.$return, 'class'=>'form-horizontal col-sm-12','files' => true , 'parsley-validate'=>'','novalidate'=>' ')) !!}

					 ...
					 <td>
						@if($field['field'] == 'avatar')
						 ...
						 @elseif($field['field'] =='date')
							 {{  \App\Library\DateHelpers::formatDate($row->date) }}
						 @elseif($field['field'] =='last_login')
							 {{  \App\Library\DateHelpers::formatDateTime($row->last_login) }}
						 @elseif($field['field'] =='last_activity')
							 {{  \App\Library\DateHelpers::formatDateTime($row->last_activity) }}
						 @elseif($field['field'] =='updated_at')
							 {{  \App\Library\DateHelpers::formatDate($row->updated_at) }}
						 @elseif($field['field'] =='created_at')
							 {{  \App\Library\DateHelpers::formatDate($row->created_at) }}
						@else

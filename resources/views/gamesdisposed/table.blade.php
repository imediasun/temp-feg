    ...
    <table class="table table-striped datagrid " id="{{ $pageModule }}Table">
        ...
        <tr>
            ...
            @if($setting['disablerowactions']=='false')
                <th width="90" align="center"><?php echo Lang::get('core.btn_action') ;?></th>
            @endif
        </tr>
        </thead>
        ...
        <tbody>
			...
			<tr @if($access['is_edit']=='1') class="editable" @endif id="form-{{ $row->id }}" id="form-{{ $row->id }}"
				...
				@if($access['is_edit']=='1') ondblclick="showFloatingCancelSave(this)" @endif @endif>
					...
					<td><a href="javascript:void(0)" class="expandable" rel="#row-{{ $row->id }}" data-url="{{ url('gamesdisposed/show/'.$id) }}"><i class="fa fa-plus " ></i></a></td>
					@endif

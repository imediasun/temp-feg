...
@if($setting['form-method'] =='native')
	<div class="sbox">
		<div class="sbox-title">  
			<h4> @if($id)
					<i class="fa fa-pencil"></i>&nbsp;&nbsp;Edit Report: Merchandize Expenses
				@else
					<i class="fa fa-plus"></i>&nbsp;&nbsp;Create New Report: Merchandize Expenses
				@endif
...
@endif	
			{!! Form::open(array('url'=>'merchandiseexpensesreport/save/'.SiteHelpers::encryptID($row['id']), 'class'=>'form-horizontal','files' => true , 'parsley-validate'=>'','novalidate'=>' ','id'=> 'merchandiseexpensesreportFormAjax')) !!}
			<div class="col-md-12">
						<fieldset>
...
$(document).ready(function() { 
	...
	var form = $('#merchandiseexpensesreportFormAjax'); 
	form.parsley();

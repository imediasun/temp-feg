<?php
        Route::controller('users', 'Core\UsersController');
                    Route::controller('groups', 'Core\GroupsController');
                    Route::controller('pages', 'PagesController');
                    Route::controller('tasks', 'Feg\System\TasksController');
                    Route::controller('systememailreportmanager', 'Feg\System\SystemEmailReportManagerController');

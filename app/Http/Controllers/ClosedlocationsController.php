...
use App\Models\Closedlocations;
use Illuminate\Http\Request;
use Illuminate\Pagination\LengthAwarePaginator as Paginator;
use Validator, Input, Redirect ; 

class ClosedlocationsController extends ReportsController {

	protected $layout = "layouts.main";
	protected $data = array();	
	public $module = 'closedlocations';
	static $per_page	= '10';
	
	public function __construct() 
	{
		parent::__construct();
		$this->model = new Closedlocations();
		...
		$this->data = array(
			...
			'pageModule'		=> 'closedlocations',
			'pageUrl'			=>  url('closedlocations'),
	...
	public function getIndex()
	{
		...
		return view('closedlocations.index',$this->data);
	}

	public function postData( Request $request)
	{

        $module_id = \DB::table('tb_module')->where('module_name', '=', 'closedlocations')->pluck('module_id');
...
// Render into template
		return view('closedlocations.table',$this->data);
	...
	function getUpdate(Request $request, $id = null)
	{
		...
		return view('closedlocations.form',$this->data);
	}
	...
	public function getShow( $id = null)
	{
		...
		$this->data['setting'] 		= $this->info['setting'];
		$this->data['fields'] 		= \AjaxHelpers::fieldLang($this->info['config']['forms']);
		return view('closedlocations.view',$this->data);
	}

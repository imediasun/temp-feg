...
use App\Models\Gamesnotplayed;
use Illuminate\Http\Request;
use Illuminate\Pagination\LengthAwarePaginator as Paginator;
use Validator, Input, Redirect;

class GamesnotplayedController extends Controller
{

    protected $layout = "layouts.main";
    protected $data = array();
    public $module = 'gamesnotplayed';
    static $per_page = '10';

    public function __construct()
    {
        parent::__construct();
        $this->model = new Gamesnotplayed();
        ...
        $this->data = array(
            ...
            'pageModule' => 'gamesnotplayed',
            'pageUrl' => url('gamesnotplayed'),
    ...
    public function getIndex()
    {
        ...
        return view('gamesnotplayed.index', $this->data);
    }

    public function postData(Request $request)
    {

        $module_id = \DB::table('tb_module')->where('module_name', '=', 'gamesnotplayed')->pluck('module_id');
        ...
        $pagination->setPath('gamesnotplayed/data');
...
// Render into template
        return view('gamesnotplayed.table', $this->data);
    ...
    function getUpdate(Request $request, $id = null)
    {
        ...
        return view('gamesnotplayed.form', $this->data);
    }
    ...
    public function getShow($id = null)
    {
        ...
        $this->data['fields'] = \AjaxHelpers::fieldLang($this->info['config']['forms']);
        return view('gamesnotplayed.view', $this->data);
    }

        ...
        foreach ($str as $f) {
            ...
            if ($f['view'] == 1) {
                if ($f['type'] == 'textarea_editor' || $f['type'] == 'textarea') {
                    ...
                    $test=\Request::get($field);
                    if (isset($_POST[$field]) or isset($test)) {
                    ...
                    // if post is checkbox
                    if ($f['type'] == 'checkbox') {
                        $test1=\Request::get($field);
                        if (!is_null($_POST[$field]) or !is_null($test1)) {
                            if(!is_null($_POST[$field]))
                            $data[$field] = $_POST[$field];
                            elseif(!is_null($test1))
                            {
                                $data[$field] = $test1;
                            }
                        }
...
$test3=\Request::get($field);
                        ...
                        if (isset($f['option']['select_multiple']) && $f['option']['select_multiple'] == 1) {
                            ...
                            elseif(isset($test3))
                            {
                                ...
                                $multival = (is_array($test3) ? implode(",", $test3) : $test3);
                            }

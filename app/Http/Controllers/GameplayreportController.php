...
use App\Models\Gameplayreport;
use Illuminate\Http\Request;
use Illuminate\Pagination\LengthAwarePaginator as Paginator;
use Validator, Input, Redirect;

class GameplayreportController extends Controller
{

    protected $layout = "layouts.main";
    protected $data = array();
    public $module = 'gameplayreport';
    static $per_page = '10';

    public function __construct()
    {
        parent::__construct();
        $this->model = new Gameplayreport();
        ...
        $this->data = array(
            ...
            'pageModule' => 'gameplayreport',
            'pageUrl' => url('gameplayreport'),
    ...
    public function getIndex()
    {
        ...
        return view('gameplayreport.index', $this->data);
    }

    public function postData(Request $request)
    {

        $module_id = \DB::table('tb_module')->where('module_name', '=', 'gameplayreport')->pluck('module_id');
        ...
        $pagination->setPath('gameplayreport/data');
...
// Render into template
        return view('gameplayreport.table', $this->data);
    ...
    function getUpdate(Request $request, $id = null)
    {
        ...
        return view('gameplayreport.form', $this->data);
    }
    ...
    public function getShow($id = null)
    {
        ...
        $this->data['setting'] = $this->info['setting'];
        $this->data['fields'] = \AjaxHelpers::fieldLang($this->info['config']['forms']);
        return view('gameplayreport.view', $this->data);
    }

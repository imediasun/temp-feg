...
class ShopfegrequeststoreController extends Controller
{
    ...
    public function postData(Request $request)
    {
        ...
        if(isset($_GET['search'])){
            ...
            $_SESSION['shopfegrequeststore_order_type']=urldecode($_GET['order_type']);}
            if(isset($_GET['product_type'])){
                $_SESSION['shopfegrequeststore_product_type']=urldecode($_GET['product_type']);}
            if(isset($_GET['filterBy'])){
                $_SESSION['shopfegrequeststore_filterBy']=urldecode($_GET['filterBy']);
            }

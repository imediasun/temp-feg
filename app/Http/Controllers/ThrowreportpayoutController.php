...
use App\Models\Throwreportpayout;
use Illuminate\Http\Request;
use Illuminate\Pagination\LengthAwarePaginator as Paginator;
use Validator, Input, Redirect ; 

class ThrowreportpayoutController extends Controller {

	protected $layout = "layouts.main";
	protected $data = array();	
	public $module = 'throwreportpayout';
	static $per_page	= '10';
	
	public function __construct() 
	{
		parent::__construct();
		$this->model = new Throwreportpayout();
		...
		$this->data = array(
			...
			'pageModule'		=> 'throwreportpayout',
			'pageUrl'			=>  url('throwreportpayout'),
	...
	public function getIndex()
	{
		...
		return view('throwreportpayout.index',$this->data);
	}

	public function postData( Request $request)
	{

        $module_id = \DB::table('tb_module')->where('module_name', '=', 'throwreportpayout')->pluck('module_id');
		...
		$total_revenue = \DB::select("SELECT sum(merch_throws.game_earnings) as total_revenue  From merch_throws
		...
		$pagination->setPath('throwreportpayout/data');
...
// Render into template
		return view('throwreportpayout.table',$this->data);
	...
	function getUpdate(Request $request, $id = null)
	{
		...
		return view('throwreportpayout.form',$this->data);
	}

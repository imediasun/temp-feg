...
class TestmoduleController extends Controller {
	...
	public function __construct() 
	{
		...
		$this->data = array(
			...
			'pageModule'		=> 'testmodule',
			'pageUrl'			=>  url('testmodule'),
	...
	public function getIndex()
	{
		...
		return view('testmodule.index',$this->data);
	}

	public function postData( Request $request)
	{

        $module_id = \DB::table('tb_module')->where('module_name', '=', 'testmodule')->pluck('module_id');
		...
		$pagination->setPath('testmodule/data');
...
// Render into template
		return view('testmodule.table',$this->data);
	...
	function getUpdate(Request $request, $id = null)
	{
		...
		return view('testmodule.form',$this->data);
	}
	...
	public function getShow( $id = null)
	{
		...
		$this->data['setting'] 		= $this->info['setting'];
		$this->data['fields'] 		= \AjaxHelpers::fieldLang($this->info['config']['forms']);
		return view('testmodule.view',$this->data);
	}

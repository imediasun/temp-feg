...
class UsersController extends Controller
{
    ...
    function getUpdate(Request $request, $id = null)
    {
        ...
        else
        {
            ...
            $this->data['oauth_url'] = 'https://accounts.google.com/o/oauth2/v2/auth?prompt=consent&scope=https://www.googleapis.com/auth/gmail.readonly+profile+email&access_type=offline&include_granted_scopes=true&state=' . $id . '&redirect_uri=' . url('/') . env('G_REDIRECT_2') . '&response_type=code&client_id=' . env('G_ID');
            //prompt=consent&

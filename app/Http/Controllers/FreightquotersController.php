...
class FreightquotersController extends Controller
{
    ...
    public $module = 'freightquoters';
    static $per_page = '10';

    public function __construct()
    {
        parent::__construct();
        $this->model = new Freightquoters();
    ...
    public function getIndex()
    {
        ...
        return view('freightquoters.index', $this->data);
    }

    public function postData(Request $request)
    {

        $module_id = \DB::table('tb_module')->where('module_name', '=', 'freightquoters')->pluck('module_id');
        ...
        $pagination->setPath('freightquoters/data');
...
// Render into template
        return view('freightquoters.table', $this->data);
    ...
    function getUpdate(Request $request, $id = null)
    {
        ...
        if ($row) {
            ...
            $this->data['row'] = $this->model->getColumnTable('freight_companies');
        }
        $this->data['setting'] = $this->info['setting'];
        ...
        return view('freightquoters.form', $this->data);
    }
    ...
    function postCopy(Request $request)
    {
        ...
        foreach (\DB::select("SHOW COLUMNS FROM freight_companies ") as $column) {
            if ($column->Field != 'id')
        ...
        $sql = "INSERT INTO freight_companies (" . implode(",", $columns) . ") ";
        $sql .= " SELECT " . implode(",", $columns) . " FROM freight_companies WHERE id IN (" . $toCopy . ")";
        \DB::insert($sql);

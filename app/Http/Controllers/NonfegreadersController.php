...
class NonfegreadersController extends Controller {
	...
	public $module = 'nonfegreaders';
	static $per_page	= '10';
	
	public function __construct() 
	{
		parent::__construct();
		$this->model = new Nonfegreaders();
		...
		$this->data = array(
			...
			'pageModule'		=> 'nonfegreaders',
			'pageUrl'			=>  url('nonfegreaders'),
	...
	public function getIndex()
	{
		...
		return view('nonfegreaders.index',$this->data);
	}	

	public function postData( Request $request)
	{ 

        $module_id = \DB::table('tb_module')->where('module_name', '=', 'nonfegreaders')->pluck('module_id');
		...
		$pagination->setPath('nonfegreaders/data');		
		...
		return view('nonfegreaders.table',$this->data);
	...
	function getUpdate(Request $request, $id = null)
	{
		...
		return view('nonfegreaders.form',$this->data);
	}	
	...
	public function getShow( $id = null)
	{
		...
		$this->data['setting'] 		= $this->info['setting'];
		$this->data['fields'] 		= \AjaxHelpers::fieldLang($this->info['config']['forms']);
		return view('nonfegreaders.view',$this->data);	
	}	

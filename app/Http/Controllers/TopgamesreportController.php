...
use App\Models\Topgamesreport;
use Illuminate\Http\Request;
use Illuminate\Pagination\LengthAwarePaginator as Paginator;
use Validator, Input, Redirect;

class TopgamesreportController extends Controller
{

    protected $layout = "layouts.main";
    protected $data = array();
    public $module = 'topgamesreport';
    static $per_page = '10';

    public function __construct()
    {
        parent::__construct();
        $this->model = new Topgamesreport();
        ...
        $this->data = array(
            ...
            'pageModule' => 'topgamesreport',
            'pageUrl' => url('topgamesreport'),
    ...
    public function getIndex()
    {
        ...
        return view('topgamesreport.index', $this->data);
    }

    public function postData(Request $request)
    {

        $module_id = \DB::table('tb_module')->where('module_name', '=', 'topgamesreport')->pluck('module_id');
        ...
        $pagination->setPath('topgamesreport/data');
...
// Render into template
        return view('topgamesreport.table', $this->data);
    ...
    function getUpdate(Request $request, $id = null)
    {
        ...
        return view('topgamesreport.form', $this->data);
    }
    ...
    public function getShow($id = null)
    {
        ...
        $this->data['fields'] = \AjaxHelpers::fieldLang($this->info['config']['forms']);
        return view('topgamesreport.view', $this->data);
    }

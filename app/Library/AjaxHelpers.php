...
class AjaxHelpers
{
	...
	static public function buttonActionInline( $id ,$key )
	{
		...
		<div class="actionopen" style="display:none">
			<button onclick="saved(\''.$divid.'\')" class="tips btn btn-primary btn-xs" title="Save"><i class="fa  fa-save"></i></button>
			<button onclick="canceled(\''.$divid.'\')" class="tips btn btn-danger btn-xs " title="Cancel"><i class="fa  fa-repeat"></i></button>

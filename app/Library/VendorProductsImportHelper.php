...
//            dd($row);
        ...
        $marginBottomZero = 'style=" margin-bottom: 0px; "';
        ...
        $message .= '<p ' . $marginBottomZero . '><u>SKU AND BARCODE/UPC FORMATTING:</u></p>';
        $message .= '<ol ' . $marginTopZero . '>';
        ...
        $message .= '</ol>';
        $message .= '<p ' . $marginBottomZero . '><u>HOW TO ADD A NEW PRODUCT TO THE FILE:</u></p>';
        $message .= '<ol ' . $marginTopZero . '>';
        ...
        $message .= '</ol>';
        $message .= '<p ' . $marginBottomZero . '><u>HOW TO REMOVE A PRODUCT FROM THE FILE:</u></p>';
        $message .= '<ol ' . $marginTopZero . '>';
        ...
        $message .= '</ol>';
        $message .= '<p ' . $marginBottomZero . '><u>IMPORTANT:</u></p>';
        $message .= '<p ' . $marginTopZero . '>Do not make any changes to the ID field (Column A), unless an error response from our list-upload tool tells you to.</p>';

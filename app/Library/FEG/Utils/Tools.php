...
class Tools
{
    ...
    public static function injectFieldToModule($module, $injectOptions = [], $options = []) {
        ...
        FEGHelp::logPlus("      => Module $module found having module_id: $moduleId ", $L , null, $C);
        ...
        FEGHelp::logPlus("     => Detected table: $table", $L , null, $C);
        ...
        FEGHelp::logPlus('      => Preparing definition for `Table Grid` in module configuration', $L , null, $C);
        ...
        FEGHelp::logPlus('      => Backup new json configuration to file', $L , null, $C);
        ...
        FEGHelp::logPlus('      => Encode new json configuration and save to file', $L , null, $C);
        ...
        if (empty($injectOptions['simulate'])) {
            ...
            FEGHelp::logPlus('      => Saved Configuration to database', $L , $saved, $C);
            ...
            FEGHelp::logPlus('      => ** Database saving skipped as running in simulation mode', $L , null, $C);
        }



        FEGHelp::logPlus('====================================================================================', $L , null, $C);
        FEGHelp::logPlus('-------------------------- LOG AND DATA BACKUP DETAILS----------------------------------------', $L , null, $C);
        FEGHelp::logPlus("  .log file is stored in storage/logs/". @$options['logPath'], $L , null, $C);
        ...
        $messages = ['info' => 'Completed successfully'];

...
{    
    ...
    public static function test1($params = array()) {
       $L = isset($params['_logger']) ? $params['_logger'] : 
            new MyLog('daily-earnings-summary-database-cleanup.log', 'daily-summary', 'CleanupInactiveDailySummary');
        $params['_logger'] = $L;
        $uTask = isset($params['_task']) ? $params['_task'] : $params[0]['_task'];
        $runCount = $uTask->run_count;
        $isManual = $uTask->is_manual == 1;
        $isManualString = $isManual ? "(manual)" :'';
        
        
        $L->log("Start task1 [task1$isManualString] run count:$runCount");        
        $L->log("End task1 [task1$isManualString] run count:$runCount");        
        
    }
    public static function test2($params = array()) {
       $L = isset($params['_logger']) ? $params['_logger'] : 
            new MyLog('daily-earnings-summary-database-cleanup.log', 'daily-summary', 'CleanupInactiveDailySummary');
        $params['_logger'] = $L;
        $uTask = isset($params['_task']) ? $params['_task'] : $params[0]['_task'];
        ...
        $L->log("Start task2 [task1$isManualString]  run count:$runCount");        
        $L->log("End task2 [task1$isManualString] run count:$runCount");         
    }
    public static function test3($params = array()) {
       $L = isset($params['_logger']) ? $params['_logger'] : 
            new MyLog('daily-earnings-summary-database-cleanup.log', 'daily-summary', 'CleanupInactiveDailySummary');
        $params['_logger'] = $L;
        $uTask = isset($params['_task']) ? $params['_task'] : $params[0]['_task'];
        ...
        $L->log("Start task3 [task1$isManualString]  run count:$runCount");        
        $L->log("End task3 [task1$isManualString]  run count:$runCount");         
    }
    public static function test4($params = array()) {
       $L = isset($params['_logger']) ? $params['_logger'] : 
            new MyLog('daily-earnings-summary-database-cleanup.log', 'daily-summary', 'CleanupInactiveDailySummary');
        $params['_logger'] = $L;
        $uTask = isset($params['_task']) ? $params['_task'] : $params[0]['_task'];
        ...
        $L->log("Start task4 [task1$isManualString]  run count:$runCount");        
        $L->log("End task4 [task1$isManualString]  run count:$runCount");         
    }
}

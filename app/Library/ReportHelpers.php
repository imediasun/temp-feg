...
class ReportHelpers
{
    ...
    public static function getLocationNotReportingQuery($dateStart, $dateEnd, $location,
        ...
        $Q = "SELECT
                    ...
                    (SELECT date_played FROM report_locations WHERE date_played < E.date_played AND report_status = 1 AND location_id = E.location_id ORDER BY date_played DESC LIMIT 1) AS date_last_reported,

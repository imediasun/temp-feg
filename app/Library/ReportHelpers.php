...
class ReportHelpers
{
    ...
    public static function getLocationNotReportingQuery($dateStart, $dateEnd, $location, 
        ...
        $Q = "SELECT
                    ...
                    (SELECT date_played FROM report_locations WHERE id < E.id AND report_status = 1 AND location_id = E.location_id ORDER BY report_date DESC LIMIT 1) AS date_last_reported,

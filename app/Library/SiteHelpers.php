            ...
            case 'select';
                if ($option['opt_type'] == 'external') {
                    ...
                    if($option['lookup_table'] =='location')
                    {
                        ...
                        $user_ids = DB::table('user_locations')->leftjoin('location as l','user_locations.location_id','=','l.id')->where('user_locations.user_id',$current_user_id)->orderby('l.'.$option['lookup_k'])->get();

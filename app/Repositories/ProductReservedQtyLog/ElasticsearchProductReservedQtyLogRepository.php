...
class ElasticsearchProductReservedQtyLogRepository implements ProductReservedQtyLogRepository
{
    private $search;
    ...
    private function buildCollection(array $items)
    {
        ...
        return Productlog::hydrate($sources);
    }
}
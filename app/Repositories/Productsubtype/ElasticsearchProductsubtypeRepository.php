...
class ElasticsearchProductsubtypeRepository implements ProductsubtypeRepository
{
    private $search;
    ...
    private function buildCollection(array $items)
    {
        ...
        return Productsubtype::hydrate($sources);
    }
}
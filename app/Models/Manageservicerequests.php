...
FROM service_requests
  LEFT JOIN users u1
    ON (service_requests.requestor_id = u1.id)
  LEFT JOIN location
    ON (service_requests.location_id = location.id)
  LEFT JOIN service_status
    ON service_status.id = service_requests.status_id ";
	}

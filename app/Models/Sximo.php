...
// of course to revert the fetch mode you need to set it again
    ...
    public static function getRowsQuery($args, $cond = null) {
        extract(array_merge(array(
            'page' => '0',
            'limit' => '0',
            'sort' => '',
        ...
        $limitConditional = ($page != 0 && $limit != 0) ? "LIMIT  0 , $limit" : '';

        $qry=$select . " {$params} " . self::queryGroup() . " {$orderConditional}  {$limitConditional} ";
        return $qry;
    }

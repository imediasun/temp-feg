...
// of course to revert the fetch mode you need to set it again
    ...
    function getVendorPorductlist($vendor_id) {
        $row = \DB::Select("SELECT V.vendor_name AS Vendor, P.vendor_description AS Description, P.sku,P.upc_barcode, TRUNCATE(P.case_price/P.num_items,5) AS Unit_Price,
